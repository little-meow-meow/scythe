...
local log, ldexp, frexp, floor, ceil, max, setmetatable = math.log, math.ldexp, math.frexp, math.floor, math
	.ceil, math.max, setmetatable
	...
	function meta:Debug()
		...
		for i = 1, lines do
			if not foundData then
				if not self._data[i] then goto _continue end
				foundData = i
