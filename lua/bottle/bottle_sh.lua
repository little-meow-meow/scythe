...
for k, face in pairs(faces) do
    ...
    if face.dispinfo >= 0 then continue end
...
--     { pos = Vector( 10, 10, 0 ) }, -- Vertex 3
--     { pos = Vector( 10, 0,  0 ) }, -- Vertex 2
--     { pos = Vector( 0,  0,  0 ) }, -- Vertex 1
--     }
...
--         ents.FindByClass("virtual_worldspawn")[1]._mesh:Draw() -- Draw the mesh
